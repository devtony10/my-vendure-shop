...
export type ProductReviewFragment = { __typename?: 'ProductReview', id: string, createdAt: string, updatedAt: string, authorName: string, authorLocation?: string | null, summary: string, body?: string | null, rating: number, state: string, upvotes: number, downvotes: number, response?: string | null, responseCreatedAt?: string | null };
...
export type GetAllReviewsQuery = { __typename?: 'Query', productReviews: { __typename?: 'ProductReviewList', totalItems: number, items: Array<{ __typename?: 'ProductReview', id: string, createdAt: string, updatedAt: string, authorName: string, authorLocation?: string | null, summary: string, body?: string | null, rating: number, state: string, upvotes: number, downvotes: number, response?: string | null, responseCreatedAt?: string | null, product: { __typename?: 'Product', id: string, name: string, featuredAsset?: { __typename?: 'Asset', id: string, preview: string } | null } }> } };
...
export type UpdateReviewMutation = { __typename?: 'Mutation', updateProductReview: { __typename?: 'ProductReview', id: string, createdAt: string, updatedAt: string, authorName: string, authorLocation?: string | null, summary: string, body?: string | null, rating: number, state: string, upvotes: number, downvotes: number, response?: string | null, responseCreatedAt?: string | null } };
...
export type ApproveReviewMutation = { __typename?: 'Mutation', approveProductReview?: { __typename?: 'ProductReview', id: string, state: string, product: { __typename?: 'Product', id: string, customFields?: { __typename?: 'ProductCustomFields', reviewCount?: number | null, reviewRating?: number | null } | null } } | null };
...
export type RejectReviewMutation = { __typename?: 'Mutation', rejectProductReview?: { __typename?: 'ProductReview', id: string, state: string } | null };
...
export type GetReviewsHistogramQuery = { __typename?: 'Query', product?: { __typename?: 'Product', id: string, name: string, featuredAsset?: { __typename?: 'Asset', id: string, preview: string } | null, customFields?: { __typename?: 'ProductCustomFields', reviewRating?: number | null, reviewCount?: number | null } | null, reviewsHistogram: Array<{ __typename?: 'ProductReviewHistogramItem', bin: number, frequency: number }> } | null };
...
export type GetReviewDetailQuery = { __typename?: 'Query', productReview?: { __typename?: 'ProductReview', id: string, createdAt: string, updatedAt: string, authorName: string, authorLocation?: string | null, summary: string, body?: string | null, rating: number, state: string, upvotes: number, downvotes: number, response?: string | null, responseCreatedAt?: string | null, product: { __typename?: 'Product', id: string, name: string, featuredAsset?: { __typename?: 'Asset', id: string, preview: string } | null }, productVariant?: { __typename?: 'ProductVariant', id: string, name: string, featuredAsset?: { __typename?: 'Asset', id: string, preview: string } | null } | null } | null };
