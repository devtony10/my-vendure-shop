...
const config: CodegenConfig = {
  ...
  generates: {
    ...
    "src/plugins/reviews/e2e/types/shop/": {
      schema: "http://localhost:3000/shop-api",
      documents:
        "src/plugins/reviews/e2e/graphql/shop-e2e-definitions.graphql.ts",
      ...clientConfig,
    },
    "src/plugins/reviews/e2e/types/admin/": {
      schema: "http://localhost:3000/admin-api",
      documents:
        "src/plugins/reviews/e2e/graphql/admin-e2e-definitions.graphql.ts",
      ...clientConfig,
    },
    ...
    "src/plugins/doordash/generated-admin-types.ts": {
      schema: "http://localhost:3000/admin-api",
      plugins: ["typescript"],
    },
    "src/plugins/doordash/ui/gql/": {
      schema: "http://localhost:3000/admin-api",
      documents: "src/plugins/doordash/ui/**/*.ts",
      ...clientConfig,
    },
  },
};
